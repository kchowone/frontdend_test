...
/**
 //시나리오
 * 카드리스트 만들기
 * 1. html 문서를 js로 생성 or 여러개 card틀을 생성되게 만들기
 ...
 */
  ...
  * 3. 이벤트 발생시 처리된 이벤트 주체 (단, 화살표함수 사용시 this는 window)
  */
...
.then(function(data){
  ...
  elMenuList.forEach((el,index)=> {
    el.addEventListener('click',function(e){
      e.preventDefault();
      console.log(e.target.innerText);// 두개 차이 알기
  ...
  // elMenuList[0].addEventListener('click',function(e){
  //   e.preventDefault();
