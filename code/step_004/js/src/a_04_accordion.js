 ...
 *  6. 구글시트에서 json형식으로 변환하여 값 처리/변경 (https://gsx2json.com/)
...
// 변수 ----------------------------------------------------
const SHEET         = {id:'1uBiqCg2g02WMJQInQFNlhw5BxqvV9MKY4dfdcaZz80M', name:'accordion'};
...
const ACCORDIONCODE = function(number, title, content){
  ...
  <dd>
  <div class="content">${content}</div></dd>
  </dl>`
};
